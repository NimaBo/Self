...
function load_plugins()
  for k, v in pairs(_config.enabled_plugins) do
    print("[NimaBo/Self]Loading plugin", v)
    ...
    if not ok then
      print('\27[31m[NimaBo/Self]Error loading plugin '..v..'\27[39m')
	  print(tostring(io.popen("[NimaBo/Self]lua plugins/"..v..".lua"):read('*all')))
